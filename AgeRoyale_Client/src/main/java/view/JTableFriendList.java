...
/** Representa el DefaultTableModel de la JTable que contiene la lista de amigos de la vista  */
public class JTableFriendList extends DefaultTableModel {
     ...
     */
    public JTableFriendList(Object[][] data, Object[] columns) {
        super(data, columns);
    }
